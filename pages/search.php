...
<body class="search-bg"> 
	...
	<nav class="navbar navbar-expand-lg navbar-dark navbar-static-top">
		...
		<form action="result.php" method="post"> 
			...
			<div class="active-cyan-4 mb-4" id="search-box">
				<input class="form-control" type="text" name="user_query" id="search-box-width" placeholder="Search"/> 
				<!-- <input type="submit" name="search" value="Search Now"> -->
				<div class="row justify-content-center">
					<!-- <input type="submit" name="search" value="Search Now"> -->
			        <button id="search-submit-btn" type="submit" name="search" class="btn btn-secondary">Sachi Search</button>
			      </div>
			</div>
			</div>
		</form>
